...
def fetch_sheet_rows():
    """Fetch the Products tab as a list of dicts (header -> value) using the
    service account key. Returns [] if no key is configured (local dry-run)."""
    ...
    url = f"https://sheets.googleapis.com/v4/spreadsheets/{SHEET_ID}/values/{PRODUCTS_RANGE}"
